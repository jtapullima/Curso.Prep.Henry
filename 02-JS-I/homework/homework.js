...
function esPositivo(numero) {
  ...
  if (num ===0 ) {return false; } else if (num > 0) {return 'positivo'} else {return 'negativo'}
}
...
function obtenerSaludo(nombre) {
  ...
  // "Martin" -> "Hola Martin!"
  // Tu código:
  var combinacion = hola + nombre; { return conbinacion; }
}
...
function esVocal(letra){
  ...
  //Escribe tu código aquí
  if (letra . longitud > 1) {return 'dato incorrector'} if (letra === a) (letra === e) (letra === i) (letra === o) (letra === u)
